...
obs=nrow(subset(table,((table$H10!="A") & (table$reg=="SE Asia (islands)"))))
...
obs=nrow(subset(table,((table$H10!="A") & (table$reg=="SE Asia (mainland)"))))
...
obs=nrow(subset(table,((table$H10!="A") & (table$reg=="S and C Asia"))))
...
obs=nrow(subset(table,((table$H10!="A") & (table$reg=="E Africa"))))
...
obs=nrow(subset(table,((table$H10!="A") & (table$reg=="E Africa") & (table$c_i!="Madagascar"))))
...
obs=nrow(subset(table,((table$H10!="A") & (table$reg=="S Africa"))))
res_temp = c(res_SA,obs)
...
obs=nrow(subset(table,((table$H10!="A") & (table$reg=="S America"))))
...
write.table(res,file="phyC_A10X_mut.txt",row.names=F)
